(function(global) {
    ...
    document.getElementById('commands').onclick = function(ev) {
        ...
        if ($(element).hasClass('image1')) {
            fabric.Image.fromURL(this, function(image) {
                image.set({
                    left: left,
                    top: top,
                    angle: angle,
        ...
        if ($(element).hasClass('image2')) {
            fabric.Image.fromURL('assets/img/table.jpg', function(image) {
                image.set({
                    left: left,
                    top: top,
                    angle: angle,
        ...
        if ($(element).hasClass('image3')) {
            fabric.Image.fromURL('assets/img/bed.jpg', function(image) {
                image.set({
                    left: left,
                    top: top,
                    angle: angle,
